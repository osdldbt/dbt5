		...
		for (int i = 0; i < pOut->num_found; i++) {
			cout << m_pid << " -- bid_price[" << i << "]: " <<
					...
					m_pid << " -- trade_history_dts[" << i << "][0]: " <<
							...
							endl <<
					m_pid << " -- trade_history_status_id[" << i << "][0]: " <<
							pOut->trade_info[i].trade_history_status_id[0] <<
							endl <<
					m_pid << " -- trade_history_dts[" << i << "][1]: " <<
							...
							endl <<
					m_pid << " -- trade_history_status_id[" << i << "][1]: " <<
							pOut->trade_info[i].trade_history_status_id[1] <<
							endl <<
					m_pid << " -- trade_history_dts[" << i << "][2]: " <<
							...
							endl <<
					m_pid << " -- trade_history_status_id[" << i << "][2]: " <<
		...
		for (int i = 0; i < pOut->num_found; i++) {
			cout << m_pid << " -- acct_id[" << i << ": " <<
					...
					m_pid << " -- trade_history_dts[" << i << "][i]: " <<
							...
							endl <<
					m_pid << " -- trade_history_status_id[" << i << "][i]: " <<
