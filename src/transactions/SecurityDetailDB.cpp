		...
		TSecurityDetailFrame1Output *pOut)
{
	if (m_Verbose) {
		cout << m_pid << " <<< SDF1" << endl <<
				...
				m_pid << " -- access_lob_flag: " << pIn->access_lob_flag <<
						endl <<
				m_pid << " -- max_rows_to_return: " <<
						pIn->max_rows_to_return << endl <<
	...
	if (m_Verbose) {
		...
		for (i = 0; i < pOut->news_len; i++) {
			cout << m_pid << " -- news[" << i << "].item: " <<
							pOut->news[i].item << endl <<
					m_pid << " -- news[" << i << "].dts: " <<
					...
					m_pid << " -- news[" << i << "].src: " <<
							pOut->news[i].src << endl <<
					m_pid << " -- news[" << i << "].auth: " <<
							pOut->news[i].auth << endl <<
					m_pid << " -- news[" << i << "].headline: " <<
							pOut->news[i].headline << endl <<
					m_pid << " -- news[" << i << "].summary: " <<
