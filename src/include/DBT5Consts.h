...
// Transaction Names
static const char szTransactionName[12][18] = { "SECURITY_DETAIL",
	"BROKER_VOLUME", "CUSTOMER_POSITION", "MARKET_WATCH", "TRADE_STATUS",
	"TRADE_LOOKUP", "TRADE_ORDER", "TRADE_UPDATE", "MARKET_FEED",
