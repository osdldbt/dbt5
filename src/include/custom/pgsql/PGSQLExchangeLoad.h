...
public:
	...
	{
		CopyRecord(ExchangeRowFmt.c_str(), next_record.EX_ID, next_record.EX_NAME,
				next_record.EX_NUM_SYMB, next_record.EX_OPEN,
				next_record.EX_CLOSE, next_record.EX_DESC, next_record.EX_AD_ID);
	}
};
